...
const (
	AppengineApiAuthScopes = "appengineApiAuth.Scopes"
...
type GetSectionsParams struct {
	// Semester code (usually) in the format `{Year}{30|50|70}`
	Term string `form:"term" json:"term"`
}
...
// ReceiveSMSJSONRequestBody defines body for ReceiveSMS for application/json ContentType.
type ReceiveSMSJSONRequestBody = ReceiveSMSJSONBody

// UpdateUserDataJSONRequestBody defines body for UpdateUserData for application/json ContentType.
type UpdateUserDataJSONRequestBody = UpdateUserDataJSONBody

// AddTrackedSectionsForUserJSONRequestBody defines body for AddTrackedSectionsForUser for application/json ContentType.
